...
function HomePage() {
    return (
        <div className="h-screen w-full ">
            ...
            <div
                className="w-2/3 h-2/5 bg-transparent ms-80 border-t-4 border-b-4 opacity-90 flex flex-col justify-center items-center" color= "#130D13">
                <h1 className="text-7xl">EVERYDAY COMFORT</h1>
                <p className=" text-3xl text-center mt-10">Step into style and step into confidence <br/> with our curated collection of
                    footwear.</p>
            </div>
